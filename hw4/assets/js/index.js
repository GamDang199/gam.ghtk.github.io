...
const displayCourse = (course) => {
    return `
        ...
        <div class="thum-img overflow-hidden h-[250px]">
            <img class="transition-all duration-[400] hover:scale-110 w-full h-full" src="${course.image}" alt="">
        </div>
        ...
        <h4 class="title-course font-[400] text-[24px] pt-[15px] pb-[20px]">${course.name}</h4>
        <ul class="view-course flex pb-[20px]">
            <li class="mr-3"><i class="fa-regular fa-user mr-2 text-gray-400"></i><span>173</span></li>
            <li class="mr-3"><i class="fa-regular fa-clock mr-2 text-gray-400"></i><span> ${course.duration}</span></li>
        </ul>
        ...
        <div class="price-course relative border-solid border-gray-400 border-t-[1px] pb-5">
            <div class="price absolute top-0 left-0 mt-[30px]">${course.price == 0? 'Free' : course.price} </div>
