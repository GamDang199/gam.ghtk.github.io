...
export default {
    signup, login, logout,
    getListCate, createCate, updateCate, deleteCate, uploadImage,
    getListProductOfVendor, createVendorByAdmin, updateVendorByAdmin, getVendorById, getAllVendor, uploadLogoOfVendor,
}
